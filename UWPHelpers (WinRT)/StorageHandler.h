...
HRESULT GetFileHandle(winrt::Windows::Storage::StorageFile file, HANDLE* handle, HANDLE_ACCESS_OPTIONS accessMode, HANDLE_SHARING_OPTIONS shareMode);
HRESULT GetFileHandleFromFolder(winrt::Windows::Storage::StorageFolder folder, std::string filename, HANDLE* handle, HANDLE_ACCESS_OPTIONS accessMode, HANDLE_SHARING_OPTIONS shareMode, HANDLE_CREATION_OPTIONS openMode);
HRESULT GetFolderHandle(winrt::Windows::Storage::StorageFolder folder, HANDLE* handle, HANDLE_ACCESS_OPTIONS accessMode, HANDLE_SHARING_OPTIONS shareMode);
